        ...
        <div class="py-3 bg-slate-800 m-5 rounded-xl gap-6 w-2/3 px-7">
            ...
            <form action="create-admin" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div class="flex justify-center w-full gap-10">
                    <div class="w-2/4">
                        <div class="w-full ">
                            <label for="name" class="flex text-white font-medium">Nome</label>
                            <input id="name" name="name" type="text" placeholder="Nome do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="email" class="flex text-white font-medium">Email</label>
                            <input id="email" name="email" type="text" placeholder="Email do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="password" class="flex text-white font-medium">Senha</label>
                            <input id="password" name="password" type="password" placeholder="Senha do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="cep" class="flex text-white font-medium">Cep</label>
                            <input id="cep" name="cep" type="text" placeholder="Cep do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="my-5">
                            <label for="foto" class="font-medium text-white">Foto do Administrador</label>
                    ...
                    <div class=" w-1/3">
                        <div class="w-full">
                            <label for="logradouro" class="flex text-white font-medium">Logradouro</label>
                            <input id="logradouro" name="logradouro" type="text"
                                placeholder="Logradouro do Administrador" class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="bairro" class="flex text-white font-medium">Bairro</label>
                            <input id="bairro" name="bairro" type="text" placeholder="Bairro do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="cidade" class="flex text-white font-medium">Cidade</label>
                            <input id="cidade" name="cidade" type="text" placeholder="Cidade do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="estado" class="flex text-white font-medium">Estado</label>
                            <input id="estado" name="estado" type="text" placeholder="Estado do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="telefone" class="flex text-white font-medium">Telefone</label>
                            <input id="telefone" name="telefone" type="text" placeholder="Telefone do Administrador"
                                class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="data_de_nascimento" class="flex text-white font-medium">Data de nascimento do
                                Administrador</label>
                            <input id="data_de_nascimento" name="data_de_nascimento" type="date"
                                placeholder="data_de_nascimento do Administrador" class="w-full rounded-md">
                        </div>

                        <div class="w-full">
                            <label for="cpf" class="flex text-white font-medium">Cpf do Administrador</label>
                ...
                <div class="flex justify-end text-white font-bold my-5">
