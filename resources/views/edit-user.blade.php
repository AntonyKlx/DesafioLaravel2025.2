        ...
        <div class="py-3 flex bg-slate-800 m-5 rounded-xl gap-6 w-2/3 px-7">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div>
                    ...
                    <input id="saldo" name="saldo" type="text" placeholder="Saldo do usuário"
                        value="{{ $user->saldo }}">
                </div>

                <div>
                    <div class="w-full h-auto rounded ">
                        <img src="{{ asset($user->foto) }}" alt="{{ $user->name }}" class="w-1/5 h-auto py-4">
                    </div>
